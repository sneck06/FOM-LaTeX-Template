...
public class SecurityConfig {
	...
	public SecurityWebFilterChain certOnStartBoniCheck(ServerHttpSecurity serverHttpSecurity){
		return certificateForInterface.createCertificateWebFilter(serverHttpSecurity, "/startbonicheck/**");
	}
