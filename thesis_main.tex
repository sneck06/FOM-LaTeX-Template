...
\usepackage[nounderscore]{syntax}	% Write proper Backus-Naur Form, nounderscore is needed to avoid problems with cite function
\setlength{\grammarindent}{0pt}	% No indent in grammars to not having to use paragraphs and waste space
